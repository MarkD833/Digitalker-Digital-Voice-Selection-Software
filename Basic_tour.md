...
There are 4 demonstration VERIFY files which are the key to creating more ROMs:
...
I've placed the DVSS files are on the B drive (actually the \B\0 folder). Within the CP/M emulator just type B: to change to the B drive.
